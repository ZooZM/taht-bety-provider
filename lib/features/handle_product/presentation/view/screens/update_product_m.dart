...
class UpdateProductM extends StatefulWidget {
  const UpdateProductM({
    super.key,
    this.post,
  });
  final Post? post;
  ...
  @override
  State<UpdateProductM> createState() => _UpdateProductMState();
}

class _UpdateProductMState extends State<UpdateProductM> {
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  const _SubLabelBox(label: "Price:"),
                  const Spacer(
                    flex: 2,
                  ),
                  _InputBox(
